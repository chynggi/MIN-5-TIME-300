...
질문은 반드시 25자 내외로 짧게 작성하되, 사용자가 깊이 생각하고 감정을 표현할 수 있도록 해야 합니다.
...
`;
  ...
  protected getDefaultQuestion(dayOfWeek: string): QuestionGenerationResponse {
    ...
    return {
      question: defaultQuestions[dayOfWeek.toLowerCase()] || '오늘 하루 어떠셨나요?',
      confidence: 0.5,
